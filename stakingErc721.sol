...
contract NFTStaking is Ownable, IERC721Receiver, TokensWrapper {
  ...
  NerdyCoderClones nft;
  address public token;

  // maps tokenId to stake
  mapping(uint256 => Stake) public vault; 

   constructor(NerdyCoderClones _nft, address _token) { 
    nft = _nft;
    token = _token;
  }
  ...
  function _claim(address account, uint256[] calldata tokenIds, bool _unstake) internal {
    ...
    sup.tokenTransfer(earned, account);
